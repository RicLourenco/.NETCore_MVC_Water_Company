...
namespace NETCore_MVC_Water_Company.Web.Controllers
{
    public class BillsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Consumption,MonthYear")] Bill bill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Consumption,MonthYear")] Bill bill)
        {
            if (id != bill.Id)
            {
                return NotFound();
